...
import { coveredSlots, DEFAULT_SCHEDULE } from "./schedule";
...
// Weekly hours (Admin → Availability). Missing days fall back to defaults.
...
// This path is the pay-in-person flow (no charge now — Zelle or cash at the
// appointment); online payments go through /api/checkout instead.
export async function createBooking({ schedule, service, date, time, name, phone, notes }) {
