...
// Atomically claim the slot and store the booking. The slot doc id is
// "<date>_<time>", so two clients can never book the same time: the second
// transaction sees the slot exists and aborts.
